...
input_story_addr = "texts/la_comédie_humaine_(balzac)/contracted/gpt/la_comédie_humaine_200k_too_large_expected_90%.txt"
# input_story_addr = "texts/la_comédie_humaine_(balzac)/all_combined/la_comédie_humaine_all.txt"
...
final_length_tokens = 200000  # Target length for the final story
# shrinking_percent = shrink_percentage(init_length_tokens, final_length_tokens)  # Target length for the final story
shrinking_percent = 30  # if reduced by 10%, i.e. make the new file 90% of the original length
